...
# DBTITLE 1,Enable Autoreload and Suppress Warning Messages
# MAGIC %load_ext autoreload
# MAGIC %autoreload 2
# MAGIC import warnings
# MAGIC
# MAGIC warnings.simplefilter(action="ignore")

# COMMAND ----------

# DBTITLE 1,Set Default Value for Lakebase Instance Name Widget
...
# DBTITLE 1,Initialize Checkpoint Tables with Lakebase Instance Name
...
# DBTITLE 1,Define Stateful Agent Class with Tools and Lakebase Config
...
# MAGIC SYSTEM_PROMPT = (
# MAGIC     "You are a helpful assistant. Use the available tools to answer questions."
# MAGIC )
# MAGIC
# MAGIC ############################################
...
# MAGIC LAKEBASE_INSTANCE_NAME = "memory-lakebase"
# MAGIC
# MAGIC ###############################################################################
...
# MAGIC                 lambda state: [{"role": "system", "content": self.system_prompt}]
...
# MAGIC             output=outputs, custom_outputs=request.custom_inputs
# MAGIC         )
# MAGIC
...
# MAGIC                                     delta=chunk.content, item_id=chunk.id
# MAGIC                                 ),
# MAGIC                             )
...
# DBTITLE 1,Restart Python Environment for Library Updates
# dbutils.library.restartPython()

# COMMAND ----------

# DBTITLE 1,Send Initial User Message to Stateful Agent and Retriev ...
...
# DBTITLE 1,Send Follow Up Query to Agent with Thread Context
...
# DBTITLE 1,Call Agent Without Thread ID to Demonstrate State
...
# DBTITLE 1,Stream Predictive Output for User Query Processing
...
# DBTITLE 1,Invoke Agent Prediction Using Conversation Id
...
# DBTITLE 1,Configure and Log Databricks Resources for Agent Deploy
...
# DBTITLE 1,Run Model Evaluation with Relevance and Safety Scorers
import mlflow
...
# DBTITLE 1,Invoke MLflow Model Prediction for Stateful Agent Input
...
# DBTITLE 1,Configure and Register Short Term Memory Model in UC
...
# DBTITLE 1,Deploy UC Model with Zero Scale and Endpoint Tags
...
# DBTITLE 1,Monitor Serving Endpoint Deployment Status
import time
...
# DBTITLE 1,Query Model Serving Endpoint with User Input and Thread
from databricks.sdk import WorkspaceClient
...
# DBTITLE 1,Display Raw Response Variable Content
